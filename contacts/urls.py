...
urlpatterns = patterns('contacts.views',
    ...
    url(r'^regtaller/new/(?P<lang>[-\w]+)$',
        view = 'regtaller.new',
        name = 'contacts_regtaller_new',
    ),
    url(r'^regtaller/new/$',
        view = 'regtaller.new',
        name = 'contacts_regtaller_new',
    ...
    url(r'^regtaller/add/$',
        view = 'regtaller.create',
        name = 'contacts_regtaller_create',
    ),
    url(r'^regtaller/export/$',
        view = 'regtaller.export',
        name = 'contacts_regtaller_export',
    ),
    url(r'^regtaller/(?P<id>[-\d]+)/delete/$',
        view = 'regtaller.delete',
        name = 'contacts_regtaller_delete'
    ),
    url(r'^regtaller/(?P<id>[-\d]+)/edit/$',
        view = 'regtaller.update',
        name = 'contacts_regtaller_update'
    ),
    url(r'^regtaller/(?P<id>[-\d]+)/$',
        view = 'regtaller.detail',
        name = 'contacts_regtaller_detail',
    ),
    url(r'^tallers/$',
        view = 'taller.list',
    ...
    url(r'^taller/(?P<id>[-\d]+)/$',
        view = 'taller.detail',
        name = 'contacts_taller_detail',
    ),

    url(r'^regtaller/$',
        view = 'regtaller.list',
        name = 'contacts_regtaller_list',
    ),
