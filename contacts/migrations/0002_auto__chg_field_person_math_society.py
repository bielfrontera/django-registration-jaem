...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.math_society'
        db.alter_column('contacts_people', 'math_society', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'Person.math_society'
        db.alter_column('contacts_people', 'math_society', self.gf('django.db.models.fields.CharField')(max_length=1))
