...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.lang'
        db.add_column('contacts_people', 'lang', self.gf('django.db.models.fields.CharField')(default='1', max_length=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.lang'
        db.delete_column('contacts_people', 'lang')
