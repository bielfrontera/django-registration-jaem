...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.external_id'
        db.add_column('contacts_people', 'external_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.external_id'
        db.delete_column('contacts_people', 'external_id')
    ...
    models = {
        ...
        'contacts.person': {
            ...
            'laboral_cuerpo': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1', 'blank': 'True'}),
