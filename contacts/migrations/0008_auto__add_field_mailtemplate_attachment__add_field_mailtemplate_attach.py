...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailTemplate.attachment'
        db.add_column('contacts_mailtemplate', 'attachment', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'MailTemplate.attachment2'
        db.add_column('contacts_mailtemplate', 'attachment2', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailTemplate.attachment'
        db.delete_column('contacts_mailtemplate', 'attachment')

        # Deleting field 'MailTemplate.attachment2'
        db.delete_column('contacts_mailtemplate', 'attachment2')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 56, 7, 301109)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 56, 7, 300991)'}),
