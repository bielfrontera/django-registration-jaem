...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_people', 'status', self.gf('django.db.models.fields.CharField')(default='pendent', max_length=15, blank=True), keep_default=False)

        # Changing field 'Person.laboral_levels'
        db.alter_column('contacts_people', 'laboral_levels', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Person.status'
        db.delete_column('contacts_people', 'status')

        # Changing field 'Person.laboral_levels'
        db.alter_column('contacts_people', 'laboral_levels', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=100))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 21, 37, 37, 446882)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 21, 37, 37, 446773)'}),
